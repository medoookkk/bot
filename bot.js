...
client.on('message',async message => {  //MEDOOO_96#6699
  ...
  message.channel.send(embed);
   ...
   //MEDOOO_96#6699  //MEDOOO_96#6699 //MEDOOO_96#6699  //MEDOOO_96#6699  //MEDOOO_96#6699
    ...
    if(clans[clanName].applylist.includes(message.author.id)) return message.channel.send("**# لقد قدمت على دخول هذا الكلان مسبقا");  //MEDOOO_96#6699
   ...
   //MEDOOO_96#6699
    ...
    if(args[1] && args[1] === 'demote') {  //MEDOOO_96#6699
      ...
      if(clans[system[author.id].clan].creator !== message.author.id) return message.channel.send("**# هذا الأمر لضاحب الكلان فقط**");  //MEDOOO_96#6699
...
message.channel.sendEmbed(embed)
 ...
 '*** اتصل على امك و قول لها انك تحبها :heart:. ***',
    ...
    '*** روح اكل ملح + ليمون اذا مافيه اكل اي شيء من اختيار الي معك.  ***'
	 '*** روح لاي بنت قلوها احبك الخ.. وابكي في الحرام ***'
 ]
  client.on('message', message => {
    var prefix = '-';
...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' -help',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,' MEDOOO_96#6699 Is The Best ','Just Do It'];
    var i = -1;
    var j = 0;
